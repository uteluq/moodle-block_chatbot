...
$string['chatbot:addinstance'] = 'Adicionar um novo bloco de chatbot';
$string['chatbot:myaddinstance'] = 'Adicionar um novo bloco de chatbot ao Painel';
...
$string['chatbot:manage'] = 'Gerenciar configurações do chatbot';
