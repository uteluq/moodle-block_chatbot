...
$string['chatbot:addinstance'] = 'Ajoute yon nouvo blok chatbot';
$string['chatbot:myaddinstance'] = 'Ajoute yon nouvo blok chatbot nan Tablo Bòd';
...
$string['chatbot:manage'] = 'Jere paramèt chatbot';
