...
$string['chatbot:addinstance'] = 'Dodaj nowy blok chatbot';
$string['chatbot:myaddinstance'] = 'Dodaj nowy blok chatbot do pulpitu nawigacyjnego';
...
$string['chatbot:manage'] = 'Zarządzaj ustawieniami chatbot';
